			...
			'data'=>array(
				array(
					'data'=>array(
						'Contact'=>array(
							array(
								'GivenName'=>array('_'=>addslashes($fields['GivenName'])),
								'FamilyName'=>array('_'=>addslashes($fields['FamilyName'])),
								'Nickname'=>array('_'=>addslashes($fields['Nickname'])),
								'JobTitle'=>array('_'=>addslashes($fields['JobTitle'])),
								'Organization'=>array('_'=>addslashes($fields['Organization'])),
								'HomePhone'=>array('_'=>addslashes($fields['HomePhone'])),
								'WorkPhone'=>array('_'=>addslashes($fields['WorkPhone'])),
								'CellPhone'=>array('_'=>addslashes($fields['CellPhone'])),
								'Fax'=>array('_'=>addslashes($fields['Fax'])),
								'OtherPhone'=>array('_'=>addslashes($fields['OtherPhone'])),
								'PreferredPhone'=>array('_'=>addslashes($fields['PreferredPhone'])),
								'Email1'=>array('_'=>addslashes($fields['Email1'])),
								'Email2'=>array('_'=>addslashes($fields['Email2'])),
								'SMS'=>array('_'=>addslashes($fields['SMS'])),
								'PreferredEmail'=>array('_'=>addslashes($fields['PreferredEmail'])),
								'HomeAddress'=>array(
									'Street'=>array('_'=>addslashes($fields['HomeAddressStreet'])),
									'Locality'=>array('_'=>addslashes($fields['HomeAddressLocality'])),
									'Region'=>array('_'=>addslashes($fields['HomeAddressRegion'])),
									'PostalCode'=>array('_'=>addslashes($fields['HomeAddressPostalCode'])),
									'Country'=>array('_'=>addslashes($fields['HomeAddressCountry']))),
								'WorkAddress'=>array(
									'Street'=>array('_'=>addslashes($fields['WorkAddressStreet'])),
									'Locality'=>array('_'=>addslashes($fields['WorkAddressLocality'])),
									'Region'=>array('_'=>addslashes($fields['WorkAddressRegion'])),
									'PostalCode'=>array('_'=>addslashes($fields['WorkAddressPostalCode'])),
									'Country'=>array('_'=>addslashes($fields['WorkAddressCountry']))),
								'UID'=>array('_'=>addslashes($fields['UID']))
